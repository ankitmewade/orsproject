...
*/
	public static String getList(String name, String selectedVal, HashMap<String, String> map) {
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 212px;  height: 22px;' class='form-control' name='" + name + "'>");
        ...
        if (select) {
            ...
            sb.append("<option style='width: 560px;  height: 27px;' selected value=''>-----------------Select-----------------</option>");
        }
